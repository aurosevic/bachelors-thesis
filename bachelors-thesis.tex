...
%			\hspace{0.7cm}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=\textwidth]{assets/text-recognition-model-architertures.png}
		\caption{Arhitekture modela za prepoznavanje teksta sa scene}
		\label{fig:arhitekture-tr-modela}
	\end{figure}
