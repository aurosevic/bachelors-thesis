...
%			\hspace{0.7cm}
	...
	\todo[color=green!40, inline]{Dodaj informaciju o prosecnom vremenu izvrsavanja.}
	\todo[color=green!40, inline]{Prikaži slike pre i nekon detekcije teksta.}
	...
	\todo[color=green!40, inline]{Ubrzanje sistema - Kako bi dobili na ubrzanju sistema za automatsko prepoznavanje teksta sa tablica automobila, jedan od koraka bi bio uklanjanje modela za detekciju teksta. Model za detekciju teksta je imao ulogu da nakon detekcije tablica na slici finije pronadje regiju u kojoj se nalazi samo tekst od interesa prilikom obrade tablice. Taj korak bi mogao biti izbegnut kada bi odradili retreniranje modela za detekciju tablica tako da od inicijalno raca regiju relativno usko oko teksta od interesa bez teksta koji se moze naci na okvirima tablica. Takodje koriscenje modela za segmentaciju instance umesto detekcije objekta ce dati znatno poboljsanje u detekciji regije koju zauzima iskljucivo registarska tablica bez pozadine.}
	\newpage
