...
%			\hspace{0.7cm}
	...
	\subsubsection{Treniranje koristeći samo \todo[color=green!40]{Da li je 'izvornih' bolji izbor reči?}realne podatke}
	\begin{figure}[H]
		\centering
	...
	\todo[color=green!40, inline]{Dodaj grafove kako raste acc, a opada loss. Dodaj sve vrste loss-a na isti graf i opisi ih. Ovo odradi za svaki od tri pokrenuta treninga: real data, synthetic data, real + synthetic data.}
	...
	\begin{table}[h]
		...
		\begin{tabular}{|c|c|c|c|} % Define the table with 4 columns
			\hline
			\multirow{2}{*}{\textbf{Multirow}} & \multicolumn{3}{c|}{\textbf{Multicolumn}} \\ % Multirow and multicolumn header
			\cline{2-4} % Draw a line under the header
			& Subcolumn 1 & Subcolumn 2 & Subcolumn 3 \\ % Subcolumns under the parent columns
			\hline
			Row 1 Data & Data 1 & Data 2 & Data 3 \\ % First row of data
			\hline
			Row 2 Data & Data 4 & Data 5 & Data 6 \\ % Second row of data
			\hline
			\multirow{2}{*}{Row 3} & Data 7 & Data 8 & Data 9 \\ % Multirow in the body
			\cline{2-4} % Draw a line under the multirow
			& Data 10 & Data 11 & Data 12 \\ % Second part of the multirow
			\hline
		\end{tabular}
	...
	\begin{table}[h]
		\centering
		\small
		\begin{tabular}{|p{4cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|} % Five columns
			\hline
			\multirow{3}{*}{\diagbox[width=4.5cm]{trening skup}{test skup podataka}} & \multicolumn{2}{c|}{realni} & \multicolumn{2}{c|}{sintetički} & \multicolumn{2}{c|}{realni i sintetički} \\ % First column spans two rows, three parent columns with two sub-columns each
			\cline{2-7} % Draw a line under the header
			& Tačnost & Sigurnost & Tačnost & Sigurnost & Tačnost & Sigurnost \\ % Subcolumns under the parent columns
			\hline
			Realni & Data 1 & Data 2 & Data 3 & Data 4 & Data 1 & Data 2 \\ % First row of data
			\hline
			Sintetički & Data 5 & Data 6 & Data 7 & Data 8 & Data 1 & Data 2 \\ % Second row of data
			\hline
			Realni i sintetički & Data 9 & Data 10 & Data 11 & Data 12 & Data 1 & Data 2 \\ % Third row of data
			\hline
		\end{tabular}
	...
	r\&s on real \& synthetic
	Average confidence: 0.9932930586863463
	Accuracy: 0.9998932023281892 | Number of samples: 18727
	
	\todo[color=green!40, inline]{Odradi evaluaciju nad testnim podacima iz sintetičkog skupa kao i spojenih sitnetičkih i realnih skupova podataka.}
	
	\subsection{Važnost treniranja modela sa podacima sličnim onima koji će biti korišćeni}
	Treniranje modela sa podacima koji su slični onima koji će se koristiti u stvarnom svetu je neophodno kako bi postigli visoke performanse i tačnosti. Kada se model trenira na relevantnim i reprezentativnim podacima, on može bolje da razume obrasce i karakteristike koje će se pojaviti u novim, nepoznatim podacima.
	
	Ako su podaci korišćeni za treniranje značajno različiti od onih koji se koriste u praksi, model može imati problema sa generalizacijom, što može dovesti do loših predikcija. Stoga je važno osigurati da skup podataka za treniranje obuhvata raznovrsne i realistične primere koji odražavaju stvarne uslove rada.
	
	Model opšte namene za prepoznavanje teksta koji sam koristio kao startni model za treniranje na slikama tablica ima neprihvatljivo lošu tačnost za produkcione uslove. Tačnost startnog modela na realnim podacima je 87.68\%, na sintetičkim 88.38\% i na kombinovanim skupu ralnih i sintetičkih podataka 88.35\%. Preimetno je da se startni model prilikom evaluacije konzistentno ponaša na sva tri skupa podataka sa kojima sam trenirao model, što je dodatni pokazatelj da prilikom treniranja modela za prepoznavanje teksta na tablicama nije došlo do prekomerne prilagođenosti podacima, već je startni model naučio da prepoznaje novi tip podataka.
	...
	\section{Rezultati}
	\todo[color=green!40, inline]{Dodaj raznovrsne primere slika tablica i rezultate modela za citanje. Uključi primere tablica koji izgledaju dobro, kao i primere koji su jedva čitljivi ili objektivno nečitljivi.}
	\newpage
	
	\section{Buduća poboljšanja}
	\todo[color=green!40, inline]{Dodavanje skupa tablica iz ostalih zemalja. Jer iako model prilično dobro prepoznaje tekst sa tablica iz država koje nije video, bilo bi dobro dodati takve podatke u trening skup, jer države često imaju svoj specifičan font ili specifične karaktere koje model nije video prilikom treninga sa srpskim tablicama.}
	\todo[color=green!40, inline]{Prikazati kako se model ponaša nad ekstremno lošim podacima ili nad podacima koje nije video do sada. Npr kod podataka koje nije video, može lako doći do pogrešnog prepoznavanja karaktera O i 0 ili I i 1 i sl. Slike se nalaze na: /home/andrija/Pictures/OpenParking/Old/quick\_test/}
	\newpage
