...
%			\hspace{0.7cm}
	...
	\todo[color=green!40, inline]{Dodaj grafove kako raste acc, a opada loss. Dodaj sve vrste loss-a na isti graf i opisi ih. Ovo odradi za svaki od tri pokrenuta treninga: real data, synthetic data, real + synthetic data. Takodje prikazi evaluaciju sva tri modela nad sva tri tipa eval podataka. Prikazi i screenshot-ove terminala prilikom treninga.}
